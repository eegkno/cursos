...
'''Ahora que ya sabe utilizar comparaciones hacer un programa que contenga la
   edad de varias personas y decir si es cierta o falsa la afirmación mediante
   una función, además use la impementación de la función main'''
